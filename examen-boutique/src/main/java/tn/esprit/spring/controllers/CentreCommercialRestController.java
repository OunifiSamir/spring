...
public class CentreCommercialRestController {
	...
	public void ajouterEtaffecterListeboutiques(@RequestBody List<Boutique> listboutiques, @PathVariable("id-centre") Long idCentre)
	
	
	{
		
		centreCommercialService.ajouterEtaffecterListeboutiques(listboutiques, idCentre);
	}
